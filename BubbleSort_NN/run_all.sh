...
if [ -f "measurements.csv" ]; then
    mv measurements.csv o0_int_100000.csv
...
# Verifica se o arquivo measurements.csv existe e renomeia
if [ -f "measurements.csv" ]; then
    mv measurements.csv o0_float_100000.csv
...
# Verifica se o arquivo measurements.csv existe e renomeia
if [ -f "measurements.csv" ]; then
    mv measurements.csv o0_double_100000.csv
...
# Verifica se o arquivo measurements.csv existe e renomeia
if [ -f "measurements.csv" ]; then
    mv measurements.csv o0_string_100000.csv
